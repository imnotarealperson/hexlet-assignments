...
class ApplicationTest {
    ...
    public void testShow() throws Exception {
        ...
        assertThatJson(body).and(
                a-> a.node("title").isString().isEqualTo(task.getTitle()),
                a -> a.node("description").isString().isEqualTo(task.getDescription())
        );
    }
    ...
    public void testUpdate() throws Exception {
        ...
        assertThat(createdTask.getTitle()).isEqualTo(data.get("title"));
    }
